		...
		engine.lookup(txt, function(resultset) {
			...
			resultset.forEach(function(entry) {
				if (entry instanceof fullproof.ScoredElement) {
					...
					result += "<tr><td>" + (split[0]?split[0]:"-") +"</td><td>" + (split[1]?split[1]:"-") + "</td><td>"+ (split[2]?split[2]:"-") + "</td><td>" + (split[3]?split[3]:"-") + "</td><td>" + (split[4]?split[4]:"-") + "</td><td>" + (split[5]?split[5]:"-") + "</td><td>" + entry.score.toFixed(3)+"</td></tr>";
				} else {
					var split = data[line].split(";");
					result += "<tr><td>" + (split[0]?split[0]:"-") +"</td><td>" + (split[1]?split[1]:"-") + "</td><td>"+ (split[2]?split[2]:"-") + "</td><td>" + (split[3]?split[3]:"-") + "</td><td>" + (split[4]?split[4]:"-") + "</td><td>" + (split[5]?split[5]:"-") + "</td></tr>";
				}
			});
			result += "</table>";
